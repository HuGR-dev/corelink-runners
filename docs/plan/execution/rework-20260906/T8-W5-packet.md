...
Copy the64-line frozen implementation anchor into the existing scaffold. Preserve registered/revoke_requested/revoked behavior and exact identity validation. No suspension epoch/migration behavior changes in this extraction.
...
Source to transcribe: `T8-W5-implementation-anchor.txt` in this directory.
