...
### Scaffold B2 após o merge B1

B1/#559 foi confirmado na `origin/main` como `0cc2d82373b9786450414a77dba656ea43e015a0`. O branch de integração B2 é `bundle/b2-sprint2-closeout-20260906`, criado exatamente desse merge em `/private/tmp/corelink-b2-integration-20260907`. O escopo B2 está congelado em exatamente 14 WPs: `T2-W2b`, `T2-W4`, `T2-W6`, `T4-W1`, `T4-W2`, `T3-W3`, `T3-W1`, `T3-W2`, `T8-W1`, `T8-W3`, `T3-W14`, `T3-W9`, `T8-W5` e `T8-W2`.

Este congelamento fixa somente base, branch e população; não altera contrato, aceite, dependência, dono ou estado de implementação. O gate canônico do DAG permanece `NOT FROZEN · NOT DISPATCHABLE · quiet count 0`: até a sequência de revisões quiet/promoção/baseline prevista nele, nenhum WP é despachado. Quando esse gate levantar, os tokens D/O/R bloqueiam apenas as linhas que os nomeiam e seus descendentes.
...
1. **[CONCLUÍDO] Consolidar a base e preparar B1.** O merge B1/#559 foi confirmado na main remota como `0cc2d82373b9786450414a77dba656ea43e015a0`.
2. **[CONCLUÍDO] Encerrar B1 e fazer o merge 1.** O merge 1/3 está confirmado; o estado detalhado de aceite/evidência permanece no ledger e nos artefatos do PR.
3. **[PREPARAÇÃO] Encerrar B2 e fazer o merge 2.** Base e escopo B2 foram congelados no merge B1. Preservar as seis implementações completas da Sprint 2; concluir seus três parciais e cinco ainda sem implementação comprovada quando o gate de dispatch do DAG estiver liberado. Dentro da Sprint 2 ativa, consumidores podem ser implementados em paralelo quando existir contrato congelado e ausência de conflito de escrita; produção depende das capacidades reais. Aceitar B2 no SHA composto, com compatibilidade Runner/Server e ordem de deployment demonstradas.
...
Main REMOTA conferida em `0cc2d82373b9786450414a77dba656ea43e015a0` pelo merge B1/#559; referências locais antigas não são prova de estado remoto. PRs #548–#558 são referências de fonte históricas; preservar conteúdo válido e não abrir uma nova pilha de PRs individuais.
