...
**New WPs named: 12** — T3-W14, T3-W9, T3-W10, T8-W5, T8-W6, T8-W7, T8-W4,
...
| **T8-W4** *(new)* — in-box secret hygiene | AU3.26a AU1.9 | `deploy/runner/entrypoint.sh`, `deploy/runner/test/jitconfig-secret-surface.sh`, `crates/corelink-check-exec-server/src/**`, `crates/corelink-check-exec-server/tests/auth_token_file.rs` |
