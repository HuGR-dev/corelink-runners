...
The spawn Worker was rolled back to `cb704a9d-f6e0-45d7-9e68-89a263a77993` by deployment `200ea7f0-cd1b-47b2-8986-66ad6344612e` at 100%. The DevEnv app remains ready on digest `d105e11f92718d610b390a71c37acb9bfb668da278b2f80c1f617f7cd068768c`. The authenticated fleet gate was `busy=0`, `checked=0`, `unverifiable=0`, `force=false`. Intake and redrive remain paused (`1/1`).
