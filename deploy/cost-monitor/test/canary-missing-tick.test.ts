...
describe("canary missing tick boundaries", () => {
  it("does not perform a provider request for an unbound source", async () => {
    ...
    const scheduler = new MonitorScheduler({
      ...
      registrations: [{ source: "s", service: "svc", application: "app", keyId: "k", credentialEpoch: "1", secretArn: "arn", secretVersionId: "secret-version-32-chars-aaaaaaaa", allowedKinds: ["canary-tick"], intervalMs: 300000, sourceVersion: "v1", authoritySourceId: null, enabled: true }],
