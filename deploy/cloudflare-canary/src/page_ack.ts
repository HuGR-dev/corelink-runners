...
type PageDelivery = { version: "1"; page_url: string; incident_id: string; page_id: string; delivery_id: string; destination: string; payload_digest: string; delivered_at: number; alert_keys: string[] };
