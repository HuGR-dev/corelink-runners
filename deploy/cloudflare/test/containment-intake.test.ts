...
async function a317ProofHeader(claim: Record<string, unknown>, key = "REDACTED_SYNTHETIC_FIXTURE") {
...
describe("T3-W17 switch/HMAC intake matrix", () => {
  ...
  it("rejects an A3.17 capability whose signed installation differs from the webhook", async () => {
    const d = makeDO(); const e = env(d, makeKv(), makeMetrics(), { AUTOSCALER_INTAKE_PAUSED: "1", A317_LIVE_PROOF_HMAC_KEY: "REDACTED_SYNTHETIC_FIXTURE", A317_LIVE_PROOF_BUILD_SHA: "abcdef1", A317_LIVE_PROOF_REPO: "acme/repo" });
