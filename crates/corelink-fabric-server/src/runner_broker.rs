...
mod tests {
    ...
    async fn github_broker_drives_three_step_flow_repo_scope() {
        ...
        assert_eq!(
            url1,
            "https://api.github.test/repos/HuGR-Labs/corelink-runners/actions/runners/generate-jitconfig"
        );
    ...
    async fn github_broker_uses_org_endpoint_for_org_scope() {
        ...
        assert_eq!(
            url1, "https://api.github.test/orgs/HuGR-Labs/actions/runners/generate-jitconfig",
    ...
    async fn pat_broker_uses_org_endpoint_for_org_scope() {
        ...
        assert_eq!(
            url, "https://api.github.test/orgs/HuGR-Labs/actions/runners/generate-jitconfig",
            "org scope must hit the ORG generate-jitconfig endpoint"
        );
    }
